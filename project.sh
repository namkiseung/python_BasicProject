...
echo "======================================================================"
echo "=                      i2sec Linux Shell Script                      ="
echo "=                     리눅스 시스템 점검 스크립트                    ="
echo "======================================================================"
echo ""
sleep 3
...
echo "############################ 점검 시작 시간 #############################"  >> $CF 2>&1
date >> $CF 2>&1


echo "========================== 점검 시스템 정보== ===========================" >> $CF 2>&1
echo >> $CF 2>&1
...
echo "02. 패스워드 복잡성 설정(및 정책)"
echo "02. 패스워드 복잡성 설정(및 정책)" >> $CF 2>&1
