...
def processing(ip,sport,dport,fname,startTime,gettime):
    ...
    try:
        ...
        cmd="proxychains nmap -sT -PN -n -sV -max-rate 32 --max-rtt-timeout 1 -r -T5 -p {}-{} --scan-delay 1 --max-scan-delay 1 {}".format(sport, dport, ip)
        ...
        for line in p.stdout.readlines():
            result=result+line.decode('euc-kr')
